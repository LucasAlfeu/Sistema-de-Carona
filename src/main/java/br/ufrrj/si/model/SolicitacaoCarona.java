...
public class SolicitacaoCarona {
    ...
    public SolicitacaoCarona (String embarque, String desembarque, String data, int vagasDesejadas, int idUsuario, int idCarona) {
        ...
        this.confirmado = "Solicitada";
    }

    public SolicitacaoCarona(int ID_Pedido, String embarque, String desembarque, String data, int vagasDesejadas, String confirmado, int idUsuario, int idCarona) {
